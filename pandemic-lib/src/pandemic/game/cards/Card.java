...
public class Card {
    ...
    public static class InfectionCard extends Card {
         ...
         * @param fg city affecting the play of this card and affecting the
    ...
    protected void drawCityName(GraphicsCanvas g2d) {
        BitmapImage b = getBackground();
    ...
    /**
     * if the card isnt in the deck its finding out wthether the card was
     * clicked or not
     *
